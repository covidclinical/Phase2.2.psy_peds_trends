...
clinical_raw <- dplyr::select(clinical_raw, -age)
...
Percentage using as denominator total number of patients per day with a psy disorder.

Per day
- Total counts previously estimated (count_icd_per_day_psy).
- Counts per disorder group previously estimated (count_disorder_group_per_day)
...
Per week
- Counts per disorder group previously estimated (count_disorder_group_per_week)
