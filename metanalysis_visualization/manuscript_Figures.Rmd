...
```{r}
outputDir <- "../../output/previous_output/"
...
ggsave("boostrapped_all_long.png", height = 20, width = 45, units = "cm")
```
...
```{r Interrupted time series by sex bootstrap}
...
ggplot(bootstrapped_fitted_disorder,
  ...
  theme(strip.text = element_text(size = 10),
        ...
        title = element_text(size = 14),
        plot.subtitle = element_text(size = 12, face = "italic")) 
# ggsave("boostrapped_disorders.png", height = 20, width = 45, units = "cm")
