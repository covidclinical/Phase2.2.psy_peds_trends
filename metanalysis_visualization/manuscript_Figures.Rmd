...
bootstrapped_fitted_all %>%
  mutate( time_p = as.character(time_p),
                  time_p = if_else(time_p == '2020-03-01', as.character('2020-03-15'), time_p),
                  time_p = if_else(time_p == '2020-04-01', as.character('2020-03-16'), time_p),
  ...
  geom_point(data = patient_count_psy_period_psy_all,
             ...
             alpha = 0.5) +
  geom_vline(xintercept = as.Date(pandemic_start_date), linetype = 6)+
