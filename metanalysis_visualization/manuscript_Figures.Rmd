...
forest(model_meta_country, 
       ...
       header = "Countries",
       mlab = "Overall periods' slope differences")
ggsave("figure2B_metaanalysis_country.png", height = 20, width = 45, units = "cm")
...
ggplot(bootstrapped_fitted_sex, aes(x = time_p, y = predicted, group = interaction(iteration, period, sex))) +
  ...
  theme(strip.text = element_text(size = 10),
        ...
        title = element_text(size = 14),
  plot.subtitle = element_text(size = 12, face = "italic"))
ggsave("figure4_ITS_sex.png", height = 20, width = 45, units = "cm")
...
ggsave("figure3_boostrapped_disorders.png", height = 15, width = 35, units = "cm")
...
fig
ggsave("figure_supp3_counts_disorder.png", height = 20, width = 45, units = "cm")
...
counts_agg2 %>% ggplot( aes( x= as.Date( time_p ), y = value, group= group )) +
  ...
  theme(axis.text.x=element_text(angle = 45, hjust=1, size = 6), 
        ...
        panel.border = element_rect(colour = "black", fill = NA), 
        legend.position="bottom")
ggsave("figure_supp1B_counts_all.png",counts_plot, height = 20, width = 32, units = "cm")
