...
```{r}
### add CHOP 
ratios_patients_with_without_psy_chop <- read.delim ( file = "/Users/alba/Desktop/ratios_patients_with_without_psy_chop.txt")

ratios_patients_with_without_psy_all <- rbind( ratios_patients_with_without_psy_all, ratios_patients_with_without_psy_chop)
