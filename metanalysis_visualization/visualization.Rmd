...
codes_in_all_sites <- codes_in_all_sites[
  with(codes_in_all_sites, order(BCH, FRBDX, Lurie, UMICH, APHP, decreasing = TRUE)),
]
...
APHP_concepts = mental_codes_qc_output_all[ mental_codes_qc_output_all$siteid == "APHP", "concept_code"]
...
all_other_sites <- unique( c( FRBDX_concepts$concept_code, APHP_concepts$concept_code,
                              Lurie_concepts$concept_code, UMICH_concepts$concept_code ))
