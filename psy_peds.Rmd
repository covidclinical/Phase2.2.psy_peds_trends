...
```{r}
# Adjusting patient age to the time of visit, assuming the age used is the patients' age at the time of extraction (last discharge date available in the data)
...
count_sequences_hospitalisation <- function(df, ...) {
  ...
  total_span <- data.frame(total_span = seq(min(df$days_since_admission),
    ...
    left_join(df[,c("in_hospital", "days_since_admission")],
