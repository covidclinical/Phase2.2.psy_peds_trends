...
folder_4ce_files <- "/Users/hanauer/Desktop/DONT_INDEX/4ceData/Input/phase22_11NOV2021/"
obfuscation =  FALSE
#obfuscation = 3
raceAvailable = TRUE
#raceAvailable = FALSE
...
obs_raw_age <- obs_raw_age[ !is.na( obs_raw_age$calendar_date), ]
...
mental_codes_qc <- all_codes_ado %>% 
  filter( concept_code %in% mentalHealthCodes$concept_code )
...
all_codes_psy$sex <- trimws( all_codes_psy$sex)
all_codes_psy$race_4ce <- trimws( all_codes_psy$race_4ce)
